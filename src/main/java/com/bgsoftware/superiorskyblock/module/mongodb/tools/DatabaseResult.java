...
public class DatabaseResult {
    ...
    public static DatabaseResult fromObject(Object value) {
        Optional<Map<String, Object>> map = toMap(value);
        return map.map(DatabaseResult::new).orElse(null);
    }
    ...
    public static Optional<Map<String, Object>> toMap(Object value) {
    ...
    public static Optional<byte[]> getBlob(Object obj) {
